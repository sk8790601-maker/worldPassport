...
import { ArrowRight, ChevronRight, GraduationCap, Phone, Sparkles } from 'lucide-react';
      ...
      <main className="relative z-10 pt-20">
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-6 py-24 md:py-28 lg:grid-cols-[1.1fr_.9fr]">
            ...
            >
              ...
              >
                ...
                <span className="bg-gradient-to-r from-slate-200 to-slate-400 bg-clip-text text-transparent">SINGAPORE</span>
              </motion.div>
              ...
              >
                ...
                <span className="relative inline-block">
                  <span className="bg-gradient-to-r from-red-500 to-blue-500 bg-clip-text text-transparent relative z-10">Singapore</span>
        ...
        <section className="relative mx-auto max-w-7xl px-6 pb-16">
          <div className="grid items-start gap-12 lg:grid-cols-[1.05fr_1.45fr]">
            ...
            >
              <div>
                <h2 className="mb-4 text-4xl sm:text-5xl font-extrabold leading-tight text-white tracking-tight">Study in Singapore</h2>
        ...
        <section className="relative mx-auto max-w-7xl px-6 pb-24 pt-10 border-t border-white/5">
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="mb-4 text-4xl sm:text-5xl font-extrabold text-white tracking-tight">Why Choose Singapore?</h2>
