    ...
    <main className="min-h-screen bg-white overflow-hidden pt-20">
      ...
      <section className="relative mx-auto max-w-7xl px-4 pb-12">
        <div className="grid items-start gap-8 lg:grid-cols-[.82fr_1.18fr]">
          ...
          >
            <div>
              <h2 className="mb-4 text-5xl font-extrabold leading-tight text-gray-900 md:text-6xl">Study in Malaysia</h2>
      ...
      <section className="relative mx-auto max-w-7xl px-4 pb-16 pt-10">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="mb-4 text-5xl font-extrabold text-gray-900 md:text-6xl">Why Choose Malaysia?</h2>
